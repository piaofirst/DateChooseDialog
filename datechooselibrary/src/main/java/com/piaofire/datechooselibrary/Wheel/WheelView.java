...
package com.piaofire.datechooselibrary.Wheel;
...
import com.piaofire.datechooselibrary.Wheel.adapters.WheelViewAdapter;
...
//		int offset = (int) (getItemHeight() / 2);
		...
		// 绘制上边直线
		canvas.drawLine(getWidth()/5, center - offset, getWidth()/5*4, center - offset, paint);
		// 绘制下边直线
		canvas.drawLine(getWidth()/5, center + offset, getWidth()/5*4, center + offset, paint);
//		*/
//		centerDrawable.setBounds(0, center - offset, getWidth(), center + offset);
